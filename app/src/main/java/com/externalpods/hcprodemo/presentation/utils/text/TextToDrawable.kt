package com.externalpods.hcprodemo.presentation.utils.text
...
class TextToDrawable private constructor(builder: Builder) {
    ...
    class Builder {
        ...
        fun get(): BitmapDrawable {
            ...
            return TextToDrawable(this).getTextDrawable()
        }
    ...
    private fun getFirstChar(text: String): String {
        return text.first().toString().uppercase()
    }
